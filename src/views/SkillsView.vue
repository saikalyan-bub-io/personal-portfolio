    ...
    <section class="flex flex-col justify-center min-h-screen">
      <div class="grid md:grid-cols-3 gap-10 items-center">
        ...
        <div class="md:col-span-1 text-right space-y-8 font-unbounded mt-64">
          ...
          <div>
            <p class="text-2xl sm:text-3xl font-bold text-brand">Vue.js, Next.js, FastAPI</p>
            <p class="text-gray-400 text-sm uppercase tracking-wide">Frameworks</p>
          </div>

          <div>
            <p class="text-2xl sm:text-3xl font-bold text-brand">MongoDB</p>
            <p class="text-gray-400 text-sm uppercase tracking-wide">Database</p>
          </div>

          <div>
            <p class="text-2xl sm:text-3xl font-bold text-brand">GitHub</p>
